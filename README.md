...
- **Confirm the file is the real one** — the v0.1.7 installer's SHA-256 is:
  `1C9BE982606F331294E63721CAC01C3773DEDE2C3A0A91DC0CD38836E27A8110`
  Check it in PowerShell: `Get-FileHash .\Min-Max-Coach-0.1.7-setup.exe`
